...
setwd("C:/Users/saive/Desktop/Acads/MBA737/Assignment 2")
...
Error$Naive[8]=rse(test$ABC, Pred_Naive)
Error$SLR_Mod[8]=rse(test$ABC, Pred_Slr)
Error$SLR2_Mod[8]=rse(test$ABC, Pred_Slr_2)
Error$MLR_Mod[8]=rse(test$ABC, Pred_Mlr)

Error$Naive[9]=rrse(test$ABC, Pred_Naive)
Error$SLR_Mod[9]=rrse(test$ABC, Pred_Slr)
Error$SLR2_Mod[9]=rrse(test$ABC, Pred_Slr_2)
Error$MLR_Mod[9]=rrse(test$ABC, Pred_Mlr)
